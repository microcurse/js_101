 ...
 * is a numeric string between 0 and 255 as required for IP numbers and asked Ben to use 
 ...
 * input string has more or less than 4 components, e.g., 4.5.5 or 1.2.3.4.5: both those
...
function isDotSeparatedIpAddress(inputString) {
  ...
  if (dotSeparatedWords.length !== 4) {
    return "That's not a valid IP Address";
  }
...
console.log(isDotSeparatedIpAddress('192.168.256.1'));